...
kanal.send(`
${emoji.tedoa} **${config.giriş.SunucuAdı} Sunucusuna Hoş geldin!** ${member} \`(${member.id}),\` 

${emoji.yildiz} hesabın __**${olusturulmaTarihi}**__ tarihinde __**${olusturulmaTarihiAy}**__ oluşturulmuş! 

${emoji.yildiz} Seninle birlikte ${ayarlar.emojiSayi(`${üyesayısı}`)} kişi olduk! Ses kanallarında ${ayarlar.emojiSayi(`${ses}`)} kişi bulunmakta. 

${emoji.yildiz} Sunucu kurallarımız <#${config.giriş.kurallar}> kanalında belirtilmiştir. Unutma sunucu içerisinde ki \`ceza-i işlemler\` kuralları okuduğunu varsayarak gerçekleştirilecek.

${emoji.yildiz} Kayıt olabilmek için teyit kanallarına giriş yapıp, <@&${config.roles.register}> rolündeki yetkilileri bekleyebilirsin.

${emoji.yildiz} Tagımıza ulaşmak için herhangi bir kanala \`${ayarlar.prefix}tag\` yazman yeterlidir. Şimdiden iyi eğlenceler! :tada: `)
  })
