...
if (!member) return message.channel.send(embed.setDescription(`${message.author} Lütfen bir kullanıcı belirtin @Aello/İD gibi.`)).then(tedoa => tedoa.delete({timeout : 8000})).then(message.react(emoji.redemoj))
...
if(args[1] === 'kadın') {
    ...
    exports.help = {
        name : 'kayıt-ekle',
        help: "kayıt-ekle [aello/ID] [erkek/kız] [miktar]",
        cooldown: 0
     }
